...
class WarmupDetailsPage extends StatefulWidget {
  ...
  @override
  State<WarmupDetailsPage> createState() => _WarmupDetailsPage();
}

class _WarmupDetailsPage extends State<WarmupDetailsPage> {
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ExerciseCard(
                    ...
                    description:
                        "${exercise.noOfMinutes.toString()} of workout",
